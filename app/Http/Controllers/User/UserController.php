...
class UserController extends Controller
{
    ...
    function fetch_user_compte()
    {
        $data = DB::table('users')
        ->select('users.id as user_id','users.id as id','users.avatar','users.name','users.email','users.id_role',
    ...
    public function showUser($id)
    {
        ...
        $data = DB::table('users')
        ->join('roles','users.id_role','=','roles.id')
        ->select('users.id','users.avatar','users.name','users.email','users.id_role','roles.nom as role_name',
        'users.sexe','users.telephone','users.adresse')
        ->where("users.id", $id)
        ->get();
